...
In this notebook we use the notation from the potential outcomes approach to causal inference to refer to the variables of interest. This matches the notation used in the change score analysis in [@tennant2021].
