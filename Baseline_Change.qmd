...
2.  The average treatment effect on the change score:
    ...
    This is the difference between the expected value of the change score if all patients had been treated $Y_1^x$ and the expected value if all patients had been untreated $Y_1^{x'}$. We can expand this equation to:\
    $$
