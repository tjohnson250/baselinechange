...
As expected, the summary statistics comparing control and treatment groups show differential loss to follow-up even though $L = 1$ is balanced across the two groups:
